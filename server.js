...
const onProxyReq = (proxyReq, req, res, options) => {
  ...
  proxyReq.setHeader('authorization', {oauth_consumer_key:"a4VeiMVdbUvKK9Ei51ObYRjC7", oauth_token:"909033571016376321-DyFnQ9nafYmcroQJIiwkbpp50rDXkZ1", oauth_version:"1.0"})
